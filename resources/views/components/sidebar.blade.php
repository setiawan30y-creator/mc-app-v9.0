<aside class="mc-sidebar">
    ...
    <nav class="mc-nav" aria-label="Main navigation">
        ...
        <a class="mc-nav-item" href="#">
            <span class="mc-nav-icon">
                <svg viewBox="0 0 24 24"><rect x="4" y="3" width="16" height="18" rx="2"/><path d="M8 7h8M8 11h3M13 11h3M8 15h3M13 15h3"/></svg>
            </span>
        ...
        <a class="mc-nav-item" href="#">
            <span class="mc-nav-icon">
                <svg viewBox="0 0 24 24"><path d="M7 7h13"/><path d="m16 4 3 3-3 3"/><path d="M17 17H4"/><path d="m8 14-3 3 3 3"/></svg>
            </span>
        ...
        <a class="mc-nav-item" href="#">
            <span class="mc-nav-icon">
                <svg viewBox="0 0 24 24"><path d="M4 7h16v13H4z"/><path d="M7 7V5h10v2"/><path d="M8 11h8"/></svg>
            </span>
